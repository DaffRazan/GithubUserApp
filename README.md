GithubUserApp is a mobile-app that enable us to easily find github user by searching their username and see the detail of user. The user can be favorited and stored on your mobile phone. 
